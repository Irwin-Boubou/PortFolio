...
async function main() {
  ...
  const skills: Array<{
    ...
    { name: 'CSS3', category: 'frontend', level: 94, order: 4, iconUrl: '/logos/css3.svg', brandColor: '#1572B6', description: { en: 'Modern layout (Grid, Flexbox) and animation without reaching for a framework.', fr: 'Mise en page moderne (Grid, Flexbox) et animation sans nécessairement recourir à un framework.' } },
    ...
    { name: 'Adobe Photoshop', category: 'design', level: 85, order: 1, iconUrl: '/logos/photoshop.svg', brandColor: '#31A8FF', description: { en: 'Photo retouching and raster compositing for brand and marketing assets.', fr: 'Retouche photo et compositing raster pour les assets de marque et marketing.' } },
    { name: 'Adobe Illustrator', category: 'design', level: 83, order: 2, iconUrl: '/logos/illustrator.svg', brandColor: '#FF9A00', description: { en: 'Vector logos, icon sets, and print-ready illustration work.', fr: 'Logos vectoriels, jeux d\'icônes et illustrations prêtes pour l\'impression.' } },
    { name: 'Adobe XD', category: 'design', level: 76, order: 3, iconUrl: '/logos/xd.svg', brandColor: '#FF61F6', description: { en: 'Occasional use for quick clickable prototypes shared with clients.', fr: 'Usage occasionnel pour des prototypes cliquables rapides partagés avec les clients.' } },
    ...
    { name: 'ChatGPT', category: 'ai', level: 85, order: 1, iconUrl: '/logos/openai.svg', brandColor: '#412991', description: { en: 'Quick research, brainstorming, and second opinions on tricky problems.', fr: 'Recherche rapide, brainstorming et second avis sur des problèmes complexes.' } },
    ...
    { name: 'VS Code', category: 'tools', level: 95, order: 1, iconUrl: '/logos/vscode.svg', brandColor: '#007ACC', description: { en: 'My editor of choice, tuned with a decade of extensions and shortcuts.', fr: "Mon éditeur de choix, ajusté avec une décennie d'extensions et de raccourcis." } },
